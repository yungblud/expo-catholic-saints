...
- [ ] T007 Run full test suite with `npm test` to ensure no regressions in existing tests
- [ ] T008 Run web static export with `npx expo export --platform web` and verify `/privacy-policy` page is included in dist/ output
